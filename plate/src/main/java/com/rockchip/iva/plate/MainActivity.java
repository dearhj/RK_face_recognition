...
import com.rockchip.iva.plate.BuildConfig;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        Button faceRecognition = findViewById(R.id.button_plate_recognition);
    ...
    public void startActivity(int id) {
        ...
        if (id == R.id.button_plate_recognition) {
            intent = new Intent(getApplicationContext(), PlateRecognitionActivity.class);
        }
        if (intent != null) {
